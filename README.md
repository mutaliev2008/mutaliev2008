...
Я - фронтенд-разработчик. Мои навыки включают:

* **HTML, CSS, JavaScript, React:** Я свободно владею этими языками программирования, использую их для верстки одностраничных и многостраничных сайтов.
...
* Также в настоящее время углубленно изучаю Angular, чтобы расширить свой арсенал инструментов для веб-разработки и создавать эффективные решения.



- 🔭: Изучаю frontend-разработку и с каждым днем становлюсь лучше!
